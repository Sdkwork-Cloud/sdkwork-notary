...
const SURFACES = [
  {
    ...
    routesFile: 'crates/sdkwork-router-notary-app-api/src/routes.rs',
    handlersFile: 'crates/sdkwork-router-notary-app-api/src/handlers.rs',
    packageName: 'sdkwork-router-notary-app-api',
    handlerModule: 'sdkwork_router_notary_app_api::handlers',
    crateRoot: 'crates/sdkwork-router-notary-app-api',
    crateImport: 'sdkwork_router_notary_app_api',
    ...
    manifestRs: 'crates/sdkwork-router-notary-app-api/src/manifest.rs',
  },
  {
    apiSurface: 'backend-api',
    openapiFile: 'apis/backend-api/notary/notary-backend-api.openapi.json',
    routesFile: 'crates/sdkwork-router-notary-backend-api/src/routes.rs',
    handlersFile: 'crates/sdkwork-router-notary-backend-api/src/handlers.rs',
    packageName: 'sdkwork-router-notary-backend-api',
    handlerModule: 'sdkwork_router_notary_backend_api::handlers',
    crateRoot: 'crates/sdkwork-router-notary-backend-api',
    crateImport: 'sdkwork_router_notary_backend_api',
    ...
    manifestRs: 'crates/sdkwork-router-notary-backend-api/src/manifest.rs',
  },
];
