# sdkwork-notary Source Configuration
...
| `runtimeCode` | `notary` |
| Config root | `/etc/sdkwork/notary/` |
| Runtime TOML | `/etc/sdkwork/notary/config.toml` |
| Secrets | `/etc/sdkwork/notary/secrets/` |
| Override | `SDKWORK_NOTARY_CONFIG_FILE` |
