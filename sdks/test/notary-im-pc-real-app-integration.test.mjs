...
test("notary workspace does not host a duplicate IM PC integration fork", () => {
  assert(
    !exists(workspaceRoot, "integrations/sdkwork-im-pc"),
    "sdkwork-notary must integrate through sdkwork-im/apps/sdkwork-im-pc instead of a local fork",
  );
});
...
imPcTest("real notary UI drives documents, signatures, video, and staff selection through the service", () => {
  ...
  for (const token of ["matters", "mattersLoading", "DEFAULT_MATTER_TYPE_OPTIONS"]) {
