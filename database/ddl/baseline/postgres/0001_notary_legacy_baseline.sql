-- Consolidated legacy baseline for sdkwork-notary database module.
-- Review and replace with contract-first migrations.

-- source: crates/sdkwork-notary-case-repository-sqlx/migrations/0001_notary_foundation.sql
