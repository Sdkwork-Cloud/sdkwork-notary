...
impl NotaryCaseRepositoryPort for SqliteNotaryCaseRepository {
    ...
    async fn list_organization_profiles(
        ...
        SqliteNotaryCaseRepository::list_organization_profiles(
            self,
            organization_id,
            page_size,
            cursor,
    ...
    async fn release_assignment(
        ...
        SqliteNotaryCaseRepository::release_assignment(self, case_id, assignment_id).await
    }
    ...
    async fn list_parties(
        ...
        SqliteNotaryCaseRepository::list_parties(self, query).await
    }
